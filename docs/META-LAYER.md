...
4. **Beam feel — the Wave Cannon** — a slower **projectile-front** stream that LAGS your aim (harder to redirect), charge + width control, force-vs-pierce ratings; needs a real **beam lab**.
