...
| 8 | Environmental mutation sources | 📋 | designed; no mutation-field system yet (composes with the materials system, W7) |
...
| 11.2 | Weapon HUD (ammo type shown) | 🔨 | the mag counter tags the loaded round (`30 / 90 · EXP`); penetration/noise/fire-hazard readouts are design |
