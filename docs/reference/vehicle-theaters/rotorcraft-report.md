...
| --- | ---: | ---: |
| Condor insertion runs | 50 | 50 |
| Shrike support runs | 50 | 50 |
| Insertion failures | 0 | 0 |
| Support failures | 0 | 0 |
| Shrike first contact | 5.4-10.4s | every run |
| Radar sweeps / contacts / jammed | 9975 / 472 / 362 | measured |
