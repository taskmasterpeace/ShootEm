import artifactJson from '../../data/geospatial/san-francisco-potrero.json';
...
const POTRERO_ARTIFACT = artifactJson as unknown as GeoMapArtifactV1;
...
export function generateGeospatialTheater(def: TheaterDef, seed: number): GameMap {
  const map = mapFromArtifact(POTRERO_ARTIFACT);
